...
proc update_PARAM_VALUE.HOST_BIT { PARAM_VALUE.HOST_BIT } {
	# Procedure called to update HOST_BIT when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.HOST_BIT { PARAM_VALUE.HOST_BIT } {
	# Procedure called to validate HOST_BIT
	return true
}

proc update_PARAM_VALUE.PADDR_BITS { PARAM_VALUE.PADDR_BITS } {
	# Procedure called to update PADDR_BITS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.PADDR_BITS { PARAM_VALUE.PADDR_BITS } {
	# Procedure called to validate PADDR_BITS
	return true
}

proc update_PARAM_VALUE.VALID_BIT { PARAM_VALUE.VALID_BIT } {
	# Procedure called to update VALID_BIT when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.VALID_BIT { PARAM_VALUE.VALID_BIT } {
	# Procedure called to validate VALID_BIT
	return true
}
...
proc update_MODELPARAM_VALUE.PADDR_BITS { MODELPARAM_VALUE.PADDR_BITS PARAM_VALUE.PADDR_BITS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.PADDR_BITS}] ${MODELPARAM_VALUE.PADDR_BITS}
}

proc update_MODELPARAM_VALUE.HOST_BIT { MODELPARAM_VALUE.HOST_BIT PARAM_VALUE.HOST_BIT } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.HOST_BIT}] ${MODELPARAM_VALUE.HOST_BIT}
}

proc update_MODELPARAM_VALUE.VALID_BIT { MODELPARAM_VALUE.VALID_BIT PARAM_VALUE.VALID_BIT } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.VALID_BIT}] ${MODELPARAM_VALUE.VALID_BIT}
}
