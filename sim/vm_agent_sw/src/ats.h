...
#define H2C_SHIM_PA_LO       0x3C
#define H2C_SHIM_PA_HI       0x38
#define H2C_SHIM_FIFO_NOT_EMPTY_MASK 0x00800000

//#define H2C_SHIM(X) *(u32 *)(XPAR_VM_AGENT_QDMA_SHIM_0_S00_AXI_BASEADDR + X)
